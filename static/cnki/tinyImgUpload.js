...
function tinyImgUpload(ele, options) {
    ...
    if(eleList.length == 0){
        ...
        eleList[0].innerHTML ='<div id="img-container" >'+
                '<div id="imgadd" class="img-up-add  img-item"> <span class="img-add-icon">+</span> </div>'+
                ...
                reader.onload = (function (theFile) {
                    return function (e) {
                        ...
                        oDiv.innerHTML = '<img class="thumb-icon" src="'+e.target.result+'" />'+
                                        '<a  class="img-remove">x</a><div>URL:<input  type="text" placeholder="请输入完整的网络地址" name="url" style="width:100%;margin-top:3px" /></div>'
    ...
    function uploadImg() {
        ...
        $("input[name='url']").each(function(){
        	formData.append('url', ($(this).val()==null||$(this).val()=="")?"#":$(this).val());
        })
