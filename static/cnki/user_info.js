...
UserInfoDlg.collectData = function () {
    this.set('id').set('account').set('sex').set('password').set('avatar')
        .set('email').set('name').set('birthday').set('rePassword').set('deptid').set('phone').set('type').set('deptname')
        .set('classes');
};
...
$(function () {
    ...
    var ztree = new $ZTree("treeDemo", "/region/tree");
