    ...
    function _396(_397, _398, _399) {
        ...
        function _39f() {
            ...
            if (_398 == "east") {
                ...
                return {
                    resizeC: {width: _3a4},
                    expand: {left: cc.width() - _3a3},
                    expandP: {top: _3a1.top, left: cc.width() - _3a2, width: _3a2, height: _3a1.height},
                    collapse: {left: cc.width(), top: _3a1.top, height: _3a1.height}
                };
            } else {
                if (_398 == "west") {
                    var _3a3 = p.panel("panel")._outerWidth();
                    ...
                    return {
                        resizeC: {width: _3a4, left: _3a2 - 1},
                        expand: {left: 0},
                        expandP: {left: 0, top: _3a1.top, width: _3a2, height: _3a1.height},
                        collapse: {left: -_3a3, top: _3a1.top, height: _3a1.height}
                    };
                } else {
                    if (_398 == "north") {
                        ...
                        return {
                            resizeC: {top: _3a2 - 1, height: hh},
                            expand: {top: 0},
                            expandP: {top: 0, left: 0, width: cc.width(), height: _3a2},
                            collapse: {top: -_3a5, width: cc.width()}
                        };
                    } else {
                        if (_398 == "south") {
                            var _3a5 = p.panel("panel")._outerHeight();
                            ...
                            return {
                                resizeC: {height: hh},
                                expand: {top: cc.height() - _3a5},
                                expandP: {top: cc.height() - _3a2, left: 0, width: cc.width(), height: _3a2},
    ...
    function _3a6(_3a7, _3a8) {
        ...
        function _3ad() {
            ...
            if (_3a8 == "east" && _3a9.expandEast) {
                return {
                    collapse: {left: cc.width(), top: _3ae.top, height: _3ae.height},
                    expand: {left: cc.width() - p.panel("panel")._outerWidth()}
                };
            } else {
                if (_3a8 == "west" && _3a9.expandWest) {
                    return {
                        collapse: {left: -p.panel("panel")._outerWidth(), top: _3ae.top, height: _3ae.height},
                        expand: {left: 0}
                    };
                } else {
...
(function ($) {
    ...
    $.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults, {
        inputEvents: {click: _8a2, keydown: _8a6, paste: _8a6, drop: _8a6},
        panelWidth: null,
        panelHeight: 200,
        panelMinWidth: null,
        panelMaxWidth: null,
